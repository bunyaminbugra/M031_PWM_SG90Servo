...
void SYS_Init(void)
{
	...
	CLK_EnableModuleClock(((((2) & 0x03UL) << 30)|((((16)) & 0x1fUL) << 0)| (((2) & 0x03UL) << 28)|(((1) & 0x07UL) << 25)|((((0)) & 0x1fUL) << 20)| (((0x0) & 0x03UL) << 18)|(((0x0) & 0xffUL) << 10)|(((0x0) & 0x1fUL) << 5)));
	
	 
	CLK_SetModuleClock(((((2) & 0x03UL) << 30)|((((16)) & 0x1fUL) << 0)| (((2) & 0x03UL) << 28)|(((1) & 0x07UL) << 25)|((((0)) & 0x1fUL) << 20)| (((0x0) & 0x03UL) << 18)|(((0x0) & 0xffUL) << 10)|(((0x0) & 0x1fUL) << 5)), (0x1UL<<(0)), 0x0);
    ...
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPA_MFPL = (0x0DUL<<(12));
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPB_MFPH = 0x00000000;
...
void PWM_Init(void)
{
	...
	PWM_SetClockSource(((PWM_T *) ((( uint32_t)0x40000000) + 0x58000)), 2, (0UL));

	
	((((PWM_T *) ((( uint32_t)0x40000000) + 0x58000)))->CLKPSC[(2) >> 1] = (0x3E7)); 
	((((PWM_T *) ((( uint32_t)0x40000000) + 0x58000)))->PERIOD[(2>>1)<<1] = (0x27F)); 

	
	((PWM_T *) ((( uint32_t)0x40000000) + 0x58000))->CTL1 &= ~(0x3ul << 4 ); 

	
	do{ int i; for(i = 0; i < 6; i++) { if(((0x4UL)) & (1 << i)) { (((PWM_T *) ((( uint32_t)0x40000000) + 0x58000)))->WGCTL0 = (((((PWM_T *) ((( uint32_t)0x40000000) + 0x58000)))->WGCTL0 & ~(3UL << (i << 1))) | (((2UL)) << (i << 1))); (((PWM_T *) ((( uint32_t)0x40000000) + 0x58000)))->WGCTL0 = (((((PWM_T *) ((( uint32_t)0x40000000) + 0x58000)))->WGCTL0 & ~(3UL << ((16) + (i << 1)))) | (((0UL)) << ((16) + (i << 1)))); (((PWM_T *) ((( uint32_t)0x40000000) + 0x58000)))->WGCTL1 = (((((PWM_T *) ((( uint32_t)0x40000000) + 0x58000)))->WGCTL1 & ~(3UL << (i << 1))) | (((1UL)) << (i << 1))); (((PWM_T *) ((( uint32_t)0x40000000) + 0x58000)))->WGCTL1 = (((((PWM_T *) ((( uint32_t)0x40000000) + 0x58000)))->WGCTL1 & ~(3UL << ((16) + (i << 1)))) | (((0UL)) << ((16) + (i << 1)))); } } }while(0); 


	
	PWM_EnableOutput(((PWM_T *) ((( uint32_t)0x40000000) + 0x58000)), (0x4UL));

	
	PWM_Start(((PWM_T *) ((( uint32_t)0x40000000) + 0x58000)), (0x4UL));
}
...
int main()
{
	...
	while(1)
	{
		...
		while(pos <= end)
		{
			...
			((((PWM_T *) ((( uint32_t)0x40000000) + 0x58000)))->CMPDAT[(2)]= (pos));
